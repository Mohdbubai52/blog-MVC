<div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                                ...
                                <div class="table-responsive m-t-20 no-wrap">
                                    <table class="table vm no-th-brd pro-of-month">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="active">
                                                <td><span class="round"><img src="Assets/admin/assets/images/users/2.jpg" alt="user" width="50"></span></td>
                                                <td>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="up-img" style="background-image:url(Assets/admin/assets/images/big/img1.jpg)"></div>
                            <div class="card-body">
