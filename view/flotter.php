			...
			<div class="slider-item js-fullheight">
				...
				<div class="container-fluid p-0">
					...
					<div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end"
						...
						<img class="one-third order-md-last img-fluid" src="uploads/<?php echo $user->Product_IMG; ?>"
							alt="">
				...
				<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
					...
					<div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end"
						...
						<div class="product d-flex flex-column">
							<input type="hidden" value="<?php echo $user->Product_ID; ?>" name="product_ID">
							<a href="products?<?php echo 'Product_ID=' . $user->Product_ID; ?>" class="img-prod"> <img
									class="img-fluid" src="uploads/<?php echo $user->Product_IMG; ?>"
							...
							<div class="text py-3 pb-4 px-3">
								<div class="d-flex">
									...
									<div class="rating">
										<p class="text-right mb-0">
											<a href="products"><span class="ion-ios-star-outline"></span></a>
											<a href="products"><span class="ion-ios-star-outline"></span></a>
											<a href="products"><span class="ion-ios-star-outline"></span></a>
											<a href="products"><span class="ion-ios-star-outline"></span></a>
											<a href="products"><span class="ion-ios-star-outline"></span></a>
								...
								<form action="cart" method="post">
									<button class="add-to-cart text-center py-2 mr-1" name="Product_ID"
										value="<?php echo $user->Product_ID; ?>"><span>Add to cart <i
